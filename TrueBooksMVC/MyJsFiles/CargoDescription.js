...
app.controller('cargoController', function ($scope, $http, cargoService) {
    ...
    $scope.addCargoDesc = function () {
        ...
        tdString = tdString + '<td><div class="data2" ><input type="text" style="width:180px;" value="' + CargoDescObj.Description + '" name="CarDescription_' + vCargoDesc.length + '" id="CarDescription_' + vCargoDesc.length + '" readonly/></div></td>';
