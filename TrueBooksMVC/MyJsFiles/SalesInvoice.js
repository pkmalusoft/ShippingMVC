$(document).ready(function () {
    ...
    $("#add_charges").click(function () {
        ...
        $('#displayArea').append(
            "<tr><td>" + product + "</td><td>" + Description + "</td><td>" + Quantity + "</td><td>"
            + Unit + "</td><td>" + RateType + "</td></td>" + RateLC + "</td><td>" + RateFC + "</td><td>"
            + ValueLC + "</td><td>" + ValueFc + "</td><td>" + Tax + "</td><td>" + netvalue + "</td><td>"
            + job + "</td></tr>"
