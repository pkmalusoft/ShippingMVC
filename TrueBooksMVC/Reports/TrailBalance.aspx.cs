    ...
    public partial class TrailBalance : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/TrailBalance.rdlc");
                ...
                var dt = entity.Report_TrialBalance(fromdate,todate,Convert.ToInt32(Session["AcCompanyID"].ToString()),Convert.ToInt32(Session["fyearid"].ToString())).ToList();
                _rsource = new ReportDataSource("TrailBalance", dt);
