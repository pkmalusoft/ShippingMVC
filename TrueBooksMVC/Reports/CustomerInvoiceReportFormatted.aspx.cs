...
namespace TrueBooksMVC.Reports
{
    ...
    public partial class CustomerInvoiceReportFormatted : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int invno = 0;
            invno=Convert.ToInt32(Request.QueryString["invno"].ToString());
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/CustomerInvoiceReportFormatted.rdlc");
            ...
            var dd = entity.SP_GetCustomerInvoiceReport(invno).ToList();
            _rsource = new ReportDataSource("CustomerInvoiceReport", dd);
