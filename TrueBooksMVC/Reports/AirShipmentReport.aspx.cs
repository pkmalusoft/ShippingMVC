...
{
    [SessionExpire]
    public partial class AirShipmentReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/AirShipmentReport.rdlc");
                ...
                var dt = entity.AirshipmentReport(Convert.ToDateTime(fromdate), Convert.ToDateTime(todate));
