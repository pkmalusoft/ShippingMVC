...
{
    [SessionExpire]
    public partial class TruckConsignmentNoteFormatted : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/TruckConsignmentNoteFormatted.rdlc");
            ...
            //var dt = entity.SP_GetJobTruckConsignmentNoteReport(jobID).ToList();



            var dd = entity.SP_GetJobTruckConsignmentNoteReport(JobID).ToList();
            _rsource = new ReportDataSource("TruckConsignmentNoteDS", dd);
