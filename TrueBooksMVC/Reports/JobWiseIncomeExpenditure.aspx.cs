...
{
    [SessionExpire]
    public partial class JobWiseIncomeExpenditure : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/JobWiseIncomeExpenditure.rdlc");
